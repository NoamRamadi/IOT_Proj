...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc: Mqtt_client) -> None:
        ...
        self.eConnectbtn.setStyleSheet("color: red; background-color: lightgray;")
       

        self.ePublisherTopic = QLineEdit()
        self.ePublisherTopic.setText(DHT_topic)
	# In your ConnectionDock class constructor
        self.ePublisherTopic.setStyleSheet("background-color: lightblue;")
        ...
        formLayot.addRow("Valume", self.Valume)
        formLayot.addRow("Valume Percent", self.ValumePercent)
        widget = QWidget(self)
        ...
        self.eDisconnectbtn.setToolTip("click me to disconnect")
        self.eDisconnectbtn.clicked.connect(self.on_button_disconnect_click)
        self.eDisconnectbtn.setStyleSheet("color: white; background-color: red;")
    ...
    def on_button_disconnect_click(self) -> None:
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Trash can Valume')
    ...
    def update_data(self):
        ...
        current_data = 'Valume: ' + str(valume_current)
        ...
        self.log_trash_data(valume_current)

    def log_trash_data(self, trash_level):
        timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        log_entry = f"{timestamp}: Trash Level: {trash_level}\n"
